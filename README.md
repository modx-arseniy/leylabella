...
- оптических скроллов>> перерисовывать все вокруг них, сам скролл тоже. Но вроде бы находил комментарии, что просто энкодер чуть другой ставили в bloody r80 plus, внешне очень похожий на дефолтные кругом EC11 и тп, но опто-механические, +1 вывод; тогда подойдут обычные колесики, универсальнее! 
...
- варианта с безконечным скроллом/электромагнитным скроллом, используя запчасть Logitech MX ******/SmartWheel от m650, например(и тп Razer DeathAdder? у кого-то еще видел подобный скролл. но дорого(1к+ запчасть); + места больше займет  в случае узла из logitech mx master>> перекомпоновка опять. и вопрос нафига оно мне; но по отзывам в дешевых офисных логитеках с 1000+ dpi  и тп было говно, не настраиваемо, потому полубезполезно. стойкое привыкание вызывало только в топ мышках - там все и вся настраивалось) Но не все варианты такого имеют боковые наклоны колеса.
