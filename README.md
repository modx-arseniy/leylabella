...
- вариант антидребезга железный: https://tomshardware.com/reviews/hack-mouse-click-do-it-yourself,4458-7.html
- специализированные микросхемы, например MC14490 Устранитель дребезга шести контактов https://radioskot.ru/publ/teoria/ustranenie-drebezga-kontaktov
- https://www.rlocman.ru/shem/schematics.html?di=671283
- https://www.reddit.com/r/electronics/comments/phs43m/built_a_hardware_debounced_switch_breakout_board/?tl=ru
...
- хотсвапа микрисвитчей как на Asus ROG (но где-то видел даже более подходящие корпуса), а лучше на все микрики хотсвап, т.к. микрики дохнут кругом, а не только двоят-троят под л.кн и пр.кн, но и дохнут под скроллом, слева кнопки вперед-назад... Каретки те не видел в продаже, надо поискать, зато mill-max сокетов полно.
...
- оптических скроллов>> перерисовывать все вокруг них, сам скролл тоже. Но вроде бы находил комментарии, что просто энкодер чуть другой ставили в bloody r80 plus, внешне очень похожий на дефолтные кругом EC11 и тп, но опто-механический, +1 вывод; тогда подойдут обычные колесики, универсальнее! 
+под готовые кастомные металлические скроллы g305/g70x с ali  https://aliexpress.ru/popular/g305-scroll-wheel корпус перепроектировать
...
- варианта с безконечным скроллом/электромагнитным скроллом, используя запчасть Logitech MX Автоматический режим бесконечной прокрутки у Logitech называется «SmartShift», а у Razer — «Smart Reel».******/SmartWheel от m650, например(и тп Razer DeathAdder?); + места больше займет  в случае узла из logitech mx master>> перекомпоновка опять. и вопрос нафига оно мне; но по отзывам в дешевых офисных логитеках с 1000+ dpi  и тп было говно, не настраиваемо, потому полубезполезно. стойкое привыкание вызывало только в топ мышках - там все и вся настраивалось) Но не все варианты такого имеют боковые наклоны колеса (было в RAZER BASILISK V3, например)
"подсел на магнитные отсечки скролла. Колесико представляет собой типа статор и ротор маломощного шагового двигателя, только без обмоток, просто куча магнитных полюсов которые и обеспечивают шаги прокрутки. В Логи я так понимаю это модель M650. Поскольку "щелчки" мягкие, нужно привыкать"
